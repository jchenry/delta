...
# ENV JAVA_OPTS="-cp /opt/openapi-generator/modules/go-server-lambda-openapi-generator/target/go-server-lambda-openapi-generator-0.0.0-SNAPSHOT.jar:/opt/openapi-generator/modules/openapi-generator-cli/target/openapi-generator-cli.jar"
