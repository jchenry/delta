 ...
 * 1) Set a break point in GoServerLambdaGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class GoServerLambdaGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("go-server-lambda") // use this codegen library
              ...
              .setOutputDir("out/go-server-lambda"); // output directory
